					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								...
								<p style='color: green; font-weight: bold'>${message1}</p>
							</div>
							<ol class="breadcrumb page-breadcrumb pull-right">
								<li>
									<i class="fa fa-home"></i>
									&nbsp;
									<a class="parent-item" href="index.html">Trang Chủ</a>
									&nbsp;
									<i class="fa fa-angle-right"></i>
								</li>
								<li>
									<a class="parent-item" href="">Update</a>
									&nbsp;
									<i class="fa fa-angle-right"></i>
								</li>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-box">
								...
								<c:set var="u">${userss}</c:set>
									<form action="update.htm" enctype="multipart/form-data" method="POST">
										<div class="form-group">
											<label for="simpleFormEmail">Username</label>
											<input name="username" class="form-control" id="simpleFormmasanpham" placeholder="Nhập Username" value="${userss.username}" readonly="readonly" />
										</div>
										<div class="form-group">
											<label for="simpleFormEmail">Password</label>

											<input name="password" class="form-control" id="simpleFormtensanpham" placeholder="Nhập Password" value="${userss.password}" />
										</div>
										<div class="form-group">
											<label for="simpleFormPassword">Fullname</label>
											<input name="fullname" class="form-control" id="simpleFormgiatien" placeholder="Nhập Fullname" value="${userss.fullname}" />
										</div>
										<div class="form-group">
											<label for="simpleFormPassword">Email</label>
											<input name="email" class="form-control" id="simpleFormgiatien" placeholder="Nhập Fullname"  value="${userss.email}"/>
										</div>
										<div class="form-group">
											<label for="simpleFormPassword">Phone</label>
											<input name="phone" class="form-control" id="simpleFormgiatien" placeholder="Nhập Phone" value="${userss.phone}" />
										</div>
										<div class="form-group">
                                                <label for="simpleFormPassword">Vai trò:</label>
                                                <div class="radio radio-aqua">
                                                    <input id="radiobg4" name="role" value="false" type="radio" ${userss.role != true ? 'checked' : ''}>
                                                    <label for="radiobg4">
                                                        Customer
                                                    </label>
                                                </div>
                                                <div class="radio radio-aqua">
                                                    <input id="radiobg5" name="role"  value="true" type="radio"  ${userss.role == true ? 'checked' : ''} disabled='disabled'>
                                                    <label for="radiobg5">
                                                        Admin
                                                    </label>
                                                </div>
										...
										<div class="form-group">
											...
											<p style='color: red; font-weight: bold'>${message2}</p>
											<p style='color: red; font-weight: bold'>Vui lòng chọn lại hình khi Update</p>
											<div class="text-center">
												<div class="custom-file-img">
													<img id="image-product" width="100%" height="100%" src="../images/${userss.hinh}">
												</div>
											</div>
