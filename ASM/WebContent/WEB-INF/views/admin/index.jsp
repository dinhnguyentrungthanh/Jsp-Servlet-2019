...
<html lang="en">
    ...
    <head>
        ...
        <!-- inbox style -->
        <link href="<c:url value="/assets/css/pages/inbox.min.css" />"rel="stylesheet" type="text/css">
        <!-- Theme Styles -->
    ...
    <body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white dark-sidebar-color logo-dark">
                    ...
                    <div class="page-content">
                        <div class="page-bar">
                            <div class="page-title-breadcrumb">
                                <div class=" pull-left">
                                    <div class="page-title">Quản Lý</div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-md-6 col-12">
                                    <div class="info-box bg-b-cyan">
                                        ...
                                        <div class="info-box-content">
                                            ...
                                            <span class="info-box-number">${arrayss[0]}</span>
                                            <div class="progress">
                                                <div class="progress-bar" style="width: ${arrayss[0]}%"></div>
                                            </div>
                                            <span class="progress-description">
                                                ${arrayss[0]}% Increase in 28 Days
                                            </span>
                                        </div>
                                        <!-- /.info-box-content -->
                                    </div>
                                ...
                                <div class="col-xl-3 col-md-6 col-12">
                                    <div class="info-box bg-b-cyan">
                                        <span class="info-box-icon push-bottom"><i class="material-icons">group</i></span>
                                        <div class="info-box-content">
                                            <span class="info-box-text">Kỉ Luật</span>
                                            <span class="info-box-number">${arraysss[1]}</span>
                                            <div class="progress">
                                                <div class="progress-bar" style="width: ${arraysss[1]}%"></div>
                                            </div>
                                            <span class="progress-description">
                                                ${arraysss[1]}% Increase in 28 Days
                                            </span>
                                        </div>
                                        <!-- /.info-box-content -->
                                    </div>
                                    ...
                                    <div class="chat-sidebar-chat-user">
                                        ...
                                        <div class="chat-sidebar-chat-user-messages">
                                            <div class="post out">
                                                ...
                                                <div class="message">
                                                    <span class="arrow"></span> <a href="javascript:;" class="name">${sessionScope.USER.fullname}</a> <span class="datetime">9:10</span>
                                            ...
                                            <div class="post out">
                                                <img class="avatar" alt="" src="assets/img/dp.jpg">
                                                <div class="message">
                                                    <span class="arrow"></span> <a href="javascript:;" class="name">${sessionScope.USER.fullname}</a> <span class="datetime">9:11</span>
                                            ...
                                            <div class="post out">
                                                <img class="avatar" alt="" src="assets/img/dp.jpg">
                                                <div class="message">
                                                    <span class="arrow"></span> <a href="javascript:;" class="name">${sessionScope.USER.fullname}</a> <span class="datetime">9:26</span>
        ...
        <script src="<c:url value="/assets/js/pages/sparkline/sparkline-data.js"/>"></script>
        <!-- Common js-->
        ...
        <!-- chart js -->
        <script src="<c:url value="/assets/plugins/chart-js/Chart.bundle.js"/>"></script>
        <script src="<c:url value="/assets/plugins/chart-js/utils.js"/>"></script>
        <script src="<c:url value="/assets/js/pages/chart/chartjs/home-data.js"/>"></script>
        <!-- summernote -->
        <script src="<c:url value="/assets/plugins/summernote/summernote.min.js"/>"></script>
        <script src="<c:url value="/assets/js/pages/summernote/summernote-data.js"/>"></script>
        <!-- end js include path -->
    </body>
</html>
