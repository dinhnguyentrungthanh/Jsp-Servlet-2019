											...
											<table
												...
												<thead>
													<tr>
														...
														<th class="text-center">Departld</th>
														...
														<tr>
															...
															<c:if test="${s.gender == true}">
																	<button type="button"
																		...
																		Nam</button>
																</c:if> <c:if test="${s.gender == false}">
																	<button type="button"class="btn purple btn-outline btn-circle m-b-10">
																	Nữ</button>
																</c:if>
																</td>
														    <td class="text-center">${s.birtday}</td>
														    <td class="text-center">${s.phone}</td>
														    <td class="text-center">${s.depart.name}</td>
															<td class="text-center">
																<button class="btn btn-primary btn-xs">
																	<a href='./update-staff.htm?id=${s.id}'><i class="fa fa-pencil"></i>
																	</a>
																</button>
																<button class="btn btn-danger btn-xs remove-item"
																	data-id="" on>
																	<a href="./delete-staff.htm?id=${s.id}"><i class="fa fa-trash-o "></i></a>
																</button>
															</td>
														</tr>
													</c:forEach>
