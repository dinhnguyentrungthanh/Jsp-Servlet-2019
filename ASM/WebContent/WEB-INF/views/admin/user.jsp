					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="">List</a>&nbsp;<i
									class="fa fa-angle-right"></i></li>
													...
													<c:forEach var="u" items="${users}">
														<tr>
															...
															<c:if test="${u.role == true}">
																	<button type="button"
																		class="btn deepPink btn-outline btn-circle m-b-10">
																		Admin</button>
																</c:if> <c:if test="${u.role == false}">
																	<button type="button"class="btn purple btn-outline btn-circle m-b-10">
																	Customer</button>
																</c:if>
																</td>
															<td class="text-center">${u.email}</td>
															<td class="text-center"><img
																class="img-circle user-img-circle" width="96"
																height="96" src="../images/${u.hinh}"></td>
															<td class="text-center">
																<button class="btn btn-primary btn-xs">
																	<a href='./update.htm?id=${u.username}'><i class="fa fa-pencil"></i>
																	</a>
																</button>
																<button class="btn btn-danger btn-xs remove-item"
																	data-id="" on>
																	<a href="./delete.htm?id=${u.username}"><i class="fa fa-trash-o "></i></a>
																</button>
															</td>
														</tr>
													</c:forEach>
