						...
						<div class="col-md-12">
							<div class="card card-box">
								...
								<div class="card-body " id="bar-parent">
									...
									<form:form action="insert-staff.htm" modelAttribute="staff">
                                        ...
                                        <div class="form-group">
										 ...
										 <label for="simpleFormEmail">Phòng Ban</label>
											<form:select path="depart.id" items="${departs}" itemValue="id" itemLabel="id"  class="form-control" id="select-expand-node-levels"/>
										</div>    
