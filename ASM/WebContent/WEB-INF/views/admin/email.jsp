...
<link
	...
	rel="stylesheet" type="text/css">
<link href="<c:url value="/assets/plugins/summernote/summernote.css"/>"
	rel="stylesheet">
<!-- jquery -->
<link
	href="<c:url value="/assets/plugins/jquery-file-upload/blueimp-gallery/blueimp-gallery.min.css"/>"
	rel="stylesheet" type="text/css">
<link
	href="<c:url value="/assets/plugins/jquery-file-upload/css/jquery.fileupload.css"/>"
	rel="stylesheet" type="text/css">
<link
	href="<c:url value="/assets/plugins/jquery-file-upload/css/jquery.fileupload-ui.css" />"
	rel="stylesheet" type="text/css">
...
<link href="<c:url value="/assets/css/theme-color.css"/>"
	rel="stylesheet" type="text/css">
<!-- inbox style -->
<link href="<c:url value="/assets/css/pages/inbox.min.css" />"
	rel="stylesheet" type="text/css">
<!-- favicon -->
...
<body
					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="">Email</a>&nbsp;<i
													...
													<div class="inbox-header">
														<div class="mail-option">
															<div class="btn-group margin-top-20 ">
																<button class="btn btn-primary btn-sm margin-right-10">
															...
															<div class="compose-mail">
																<form method="post" action="send.htm">
																	<div class="form-group">
																		<label for="to" class="">From:</label> <input style="margin-top: 10px;"
																			type="text" tabindex="1" id="to" class="form-control"
																			name="from" value="thanhdntps09742@fpt.edu.vn" readonly>
																	...
																	<div class="form-group">
																		<label for="to" class="">To:</label> <input
																			type="text" tabindex="1" id="to" class="form-control"
																			name="to">
																		<div class="compose-options">
																			<a
																	...
																	<div class="form-group hidden">
																		<label for="cc" class="">Cc:</label> <input
																			type="text" tabindex="2" id="cc" class="form-control">
																	</div>
																	<div class="form-group hidden">
																		<label for="bcc" class="">Bcc:</label> <input
																			type="text" tabindex="2" id="bcc"
																			class="form-control">
																	</div>
																	<div class="form-group">
																	...
																	<div class="form-group">
																		<label for="simpleFormEmail">Nội Dung</label>
																		<textarea class="form-control" rows="5"
																			placeholder="Nhập Nội Dung Khái Niệm"
																			name="body"></textarea>
																		<script>
	...
	<!-- summernote -->
	<script
		src="<c:url value="/assets/plugins/summernote/summernote.min.js"/>"></script>
	<script
		src="<c:url value="/assets/js/pages/summernote/summernote-data.js"/>"></script>
	<!-- Common js-->
