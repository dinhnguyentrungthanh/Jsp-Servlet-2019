					...
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							...
							<ol class="breadcrumb page-breadcrumb pull-right">
								...
								<li><a class="parent-item" href="">Record</a>&nbsp;<i
									class="fa fa-angle-right"></i></li>
														...
														<tr>
															...
															<c:if test="${r.type == true}">
																	<button type="button"
																		...
																		Khen Thưởng</button>
																</c:if> <c:if test="${r.type == false}">
																	<button type="button"class="btn purple btn-outline btn-circle m-b-10">
																	Kỉ Luật</button>
																</c:if>
																</td>
														    <td class="text-center">${r.staff.id}</td>
															<td class="text-center">
																<button class="btn btn-primary btn-xs">
																	<a href='./update-record.htm?id=${r.id}'><i class="fa fa-pencil"></i>
																	</a>
																</button>
																<button class="btn btn-danger btn-xs remove-item"
																	data-id="" on>
																	<a href="./delete-record.htm?id=${r.id}"><i class="fa fa-trash-o "></i></a>
																</button>
															</td>
														</tr>
													</c:forEach>
