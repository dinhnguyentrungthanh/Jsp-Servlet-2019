					...
					<div class="row">
						<div class="col-md-12">
							<div class="card card-box">
								...
								<c:set var="u" value="${departss}"></c:set>
									<form:form action="update-staff.htm" method="POST" modelAttribute="staffss">
										<div class="form-group">
											<label for="simpleFormEmail">ID</label>
											<form:input path="id"  class="form-control" id="simpleFormaphongban" disabled="" />
										</div>
										<div class="form-group">
											<label for="simpleFormEmail">Họ Tên</label>
											<form:input path="name" class="form-control" id="simpleFormtenphongban"/>
										</div>
										<div class="form-group">
                                                <label for="simpleFormPassword">Giới Tính:</label>
                                        ...
                                        <div class="form-group">
											<label for="simpleFormEmail">Ngày Tháng Năm Sinh</label>
											<form:input path="birtday" class="form-control" id="simpleFormtenphongban" />
										</div>
										 <div class="form-group">
											<label for="simpleFormEmail">Số Điện Thoại</label>
											<form:input path="phone" class="form-control" id="simpleFormtenphongban" />
										</div>
										 <div class="form-group">
										 <label for="simpleFormEmail">Phòng Ban</label>
											<form:select path="depart.id" items="${departs}" itemValue="id" itemLabel="id"  class="form-control" id="select-expand-node-levels" readonly="readonly"/>
										</div>
