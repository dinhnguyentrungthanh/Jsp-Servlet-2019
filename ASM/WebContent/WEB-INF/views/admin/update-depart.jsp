						...
						<div class="col-md-12">
							<div class="card card-box">
								...
								<c:set var="u" value="${departss}"></c:set>
									<form:form action="update-depart.htm" method="POST" modelAttribute="departss">
										<div class="form-group">
											<label for="simpleFormEmail">Mã Phòng Ban</label>
											<form:input path="id"  class="form-control" id="simpleFormaphongban" readonly="readonly" />
										</div>
										<div class="form-group">
											<label for="simpleFormEmail">Tên Phòng Ban</label>
