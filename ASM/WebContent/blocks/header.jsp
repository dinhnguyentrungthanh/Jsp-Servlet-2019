    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="admin/index.htm">
                ...
                <span class="logo-default">Quản Lý</span> </a>
        </div>
        <!-- logo end -->
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown language-switch">
                    ...
                    <ul class="dropdown-menu animated tada">
                        <li>
                            <a class="deutsch"><img src="assets\img\flags\de.png" alt=""> VietNam</a>
                        </li>
                        <li>
                            <a class="ukrainian"><img src="assets\img\flags\ua.png" alt=""> Japan</a>
                        </li>
                        <li>
                            <a class="english"><img src="assets\img\flags\gb.png" alt=""> English</a>
                        </li>
                        <li>
                            <a class="espana"><img src="assets\img\flags\es.png" alt=""> Singapore</a>
                        </li>
                        <li>
                            <a class="russian"><img src="assets\img\flags\ru.png" alt=""> Korea</a>
                        </li>
                    </ul>
                </li>
                <!-- end language menu -->
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <img alt="" class="img-circle " src="../hinhanh/admin.jpg">
                        <span class="username username-hide-on-mobile"> ${sessionScope.USER.fullname.substring(sessionScope.USER.fullname.lastIndexOf(" "))} </span>
